...
As0 f14 type aavn.leave.request.ApproveLeaveDialog.ApproveLeaveDialogData #txt
As0 f14 actionDecl 'aavn.leave.request.ApproveLeaveDialog.ApproveLeaveDialogData out;
' #txt
...
As0 f13 type aavn.leave.request.ApproveLeaveDialog.ApproveLeaveDialogData #txt
As0 f13 guid 162CDE395D5ABA89 #txt
As0 f13 379 250 26 26 0 12 #rect
As0 f13 @|RichDialogEndIcon #fIcon
As0 f16 actionDecl 'aavn.leave.request.ApproveLeaveDialog.ApproveLeaveDialogData out;
' #txt
As0 f16 actionTable 'out=in;
' #txt
As0 f16 actionCode 'in.currentTask.reset();
in.isApprove = true;' #txt
As0 f16 security system #txt
As0 f16 type aavn.leave.request.ApproveLeaveDialog.ApproveLeaveDialogData #txt
As0 f16 184 138 112 44 0 -8 #rect
As0 f16 @|StepIcon #fIcon
As0 f17 expr out #txt
As0 f17 109 160 184 160 #arcP
As0 f5 expr out #txt
As0 f5 296 160 379 160 #arcP
As0 f18 actionDecl 'aavn.leave.request.ApproveLeaveDialog.ApproveLeaveDialogData out;
' #txt
As0 f18 actionTable 'out=in;
' #txt
As0 f18 actionCode in.currentTask.destroy(); #txt
As0 f18 security system #txt
As0 f18 type aavn.leave.request.ApproveLeaveDialog.ApproveLeaveDialogData #txt
...
As0 f17 head f16 mainIn #connect
As0 f16 mainOut f5 tail #connect
